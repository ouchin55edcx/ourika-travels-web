    ...
    <>
      <section className="mt-10 ml-2 w-full md:mx-auto md:mt-16 md:max-w-7xl md:px-6 md:py-24 md:py-32">
        ...
        <div className="mt-8 mr-2 ml-2 flex flex-col items-center gap-4 text-center sm:mt-12 md:mx-auto md:mt-16 md:max-w-xl md:gap-6 md:px-0">
          <h3 className="text-xl font-black text-[#0a2e1a] sm:text-3xl">
            Ready to create your own memories?
          </h3>
          <Link
            href="/experiences"
            className="group relative inline-flex w-full max-w-sm items-center justify-center gap-2 overflow-hidden rounded-full border-2 border-[#0a2e1a] bg-white px-6 py-3.5 text-sm font-black text-[#0a2e1a] shadow-2xl transition-all hover:scale-105 hover:bg-[#edf7f1] active:scale-95 sm:max-w-md sm:px-8 sm:py-4 sm:text-base md:max-w-none md:px-12 md:py-5 md:text-lg"
          >
