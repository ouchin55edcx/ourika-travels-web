        ...
        <div>
          <div className="relative mb-6">
            ...
            <input
              ...
              className="h-12 w-full rounded-full border border-[#8ba18d] bg-white pr-5 pl-12 text-[15px] outline-none placeholder:text-[#5f6368] focus:border-[#0a2e1a] sm:h-14 sm:text-[16px]"
            />
          </div>
