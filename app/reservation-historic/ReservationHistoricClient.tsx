...
import { Calendar, Clock, Users, Ticket, ChevronRight, History, AlertCircle } from "lucide-react";
  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-4xl space-y-8 px-4 py-8 sm:px-6">
        <div>
          <p className="text-xs font-black tracking-widest text-gray-400 uppercase">Reservations</p>
        ...
        {bookings.length === 0 ? (
          <div className="rounded-3xl border-2 border-dashed border-gray-200 p-16 text-center">
            ...
            <Link
              href="/experiences"
              className="mt-6 inline-block rounded-full bg-[#0b3a2c] px-6 py-3 text-sm font-bold text-white transition-all hover:bg-[#0f3d24]"
            >
              Browse experiences
            </Link>
          </div>
            ...
            {bookings.map((booking) => (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  {booking.guide && (
                    <div className="mt-3 flex items-center justify-between rounded-2xl border border-emerald-100 bg-[#edf7f1] px-4 py-3">
                      <div className="flex items-center gap-3">
                        <div
                          className={`flex h-9 w-9 shrink-0 items-center justify-center overflow-hidden rounded-full bg-[#0b3a2c] text-sm font-black text-white`}
                        >
                        ...
                        <div>
                          <p className="text-xs font-black text-[#0b3a2c]">Your guide</p>
