...
export default function TouristHighlight() {
    ...
    return (
        <section
            ...
            className="w-full max-w-7xl mx-auto md:px-6 py-10 md:py-16"
        >
            <div className={`bg-[#004f32] md:rounded-[2.5rem] overflow-hidden flex flex-col lg:flex-row shadow-2xl transition-all duration-700 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
                {/* Image Section */}
                <div className={`w-full lg:w-[48%] relative h-[300px] sm:h-[400px] lg:h-[550px] md:m-4 sm:m-5 lg:m-6 md:rounded-[1.5rem] overflow-hidden reveal ${isVisible ? 'reveal-visible' : ''}`}>
                    <Image
                ...
                {/* Content Section */}
                <div className={`w-full lg:w-1/2 p-8 sm:p-10 lg:p-16 flex flex-col justify-center text-white reveal ${isVisible ? 'reveal-visible' : ''}`} style={{ transitionDelay: '200ms' }}>
                    ...
                    <Link
                        href="/about"
                        className="bg-white text-black font-black px-10 lg:px-12 py-3.5 lg:py-4 rounded-full w-full sm:w-fit hover:bg-[#00ef9d] transition-all duration-300 text-base lg:text-[17px] shadow-lg active:scale-95 text-center inline-block"
                    >
                        Read more
                    </Link>
                </div>
