...
import { Info, Users, Crown, MapPin, ShieldCheck } from "lucide-react";
  ...
  return (
    <div className="grid grid-cols-1 gap-10 lg:grid-cols-[1fr_380px]">
      <div className="order-1 space-y-8 lg:order-none">
        {step === 1 && (
          <section>
            <h2 className="mb-4 text-lg font-black text-[#0b3a2c]">1. Your details</h2>
              ...
              {!prefillEmail && (
                <div className="flex items-start gap-3 rounded-2xl border border-blue-100 bg-blue-50 p-4">
                  ...
                  <p className="text-sm text-blue-700">
                    No account? No problem. We&apos;ll create one for you automatically after
                    booking so you can track your reservation.
                  </p>
                </div>
              )}
            </div>
        ...
        {step === 2 && (
          <section>
            <h2 className="mb-4 text-lg font-black text-[#0b3a2c]">2. Trip options</h2>
            <div className="space-y-6">
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <button
                  ...
                  className={`flex flex-col items-start rounded-2xl border-2 p-5 text-left transition-all ${
                    bookingType === "group"
                      ? "border-[#0b3a2c] bg-[#edf7f1] ring-2 ring-[#0b3a2c]"
              ...
              <div>
                ...
                />
                <p className="mt-1 text-xs text-gray-500">
                  Flexible dates — we&apos;ll confirm within 24h
                </p>
              </div>
              ...
              <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      onClick={() =>
                        setForm((f) => ({
                          ...f,
                          adults: Math.min(trek.max_group_size, f.adults + 1),
                        }))
                      }
                      className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 text-gray-600 hover:bg-gray-50"
                    >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      type="button"
                      onClick={() =>
                        setForm((f) => ({ ...f, children: Math.max(0, f.children - 1) }))
                      }
                      className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 text-gray-600 hover:bg-gray-50"
                    >
                      −
                    ...
                    <button
                      type="button"
                      onClick={() =>
                        setForm((f) => ({ ...f, children: Math.min(10, f.children + 1) }))
                      }
                      className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 text-gray-600 hover:bg-gray-50"
                    >
                      +
                ...
                <p className="text-xs text-gray-500">
                  Max group size: {trek.max_group_size} people
                </p>
              </div>
        ...
        {step === 3 && (
          <section>
            <h2 className="mb-4 text-lg font-black text-[#0b3a2c]">3. Review & Confirm</h2>
            <div className="space-y-6">
              <div className="rounded-2xl bg-[#0b3a2c] p-6 text-white">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-lg font-black">Pay at Ourika Travels Bureau</p>
                    <p className="mt-1 text-sm leading-relaxed text-white/80">
                      Your spot is reserved for free. Pay the full amount{" "}
                      <strong className="text-[#00ef9d]">before the activity starts</strong> at our
                      bureau in the centre of Setti Fatma — the meeting point for all our treks.
                    </p>
                ...
                <table className="w-full">
                  <tbody>
                    <tr>
                      ...
                      <td className="py-1 text-right font-semibold">{trek.title}</td>
                    </tr>
                    <tr>
                      <td className="py-1 text-gray-500">Type</td>
                      <td className="py-1 text-right font-semibold capitalize">{bookingType}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="py-1 text-right">
                        ${(form.adults * pricePerAdult).toFixed(2)}
                      </td>
                    </tr>
                    {form.children > 0 && (
                      <tr>
                        <td className="py-1 text-gray-500">
                          Children × ${pricePerChild.toFixed(2)}
                        </td>
                        <td className="py-1 text-right">
                          ${(form.children * pricePerChild).toFixed(2)}
                        </td>
                      </tr>
                    )}
                    <tr className="border-t border-gray-200">
                      <td className="py-2 font-bold text-gray-900">Total</td>
                      <td className="py-2 text-right font-black text-[#0b3a2c]">
              ...
              <div className="flex items-center gap-3 rounded-2xl border border-emerald-100 bg-emerald-50 p-4">
                ...
                <p className="text-sm font-medium text-emerald-700">
                  Free cancellation up to {trek.free_cancellation_hours}h before the start. Cancel
                  anytime from your booking history.
                </p>
              </div>
              ...
              <label className="flex items-start gap-3">
                ...
                <span className="text-sm text-gray-600">
                  I agree to Ourika Travels&apos; Terms of Service and Cancellation Policy. I
                  understand I am booking a spot and will pay at the bureau before the activity.
                </span>
              </label>
              ...
              <button
                ...
                className="w-full rounded-full bg-[#0b3a2c] py-4 text-lg font-black text-white transition-all hover:bg-[#0f3d24] disabled:cursor-not-allowed disabled:opacity-50"
              >
        ...
        <div className="flex items-center justify-between pt-4">
          ...
          {step < 3 ? (
            <button
              ...
              className="rounded-full bg-[#0b3a2c] px-6 py-2.5 text-sm font-bold text-white hover:bg-[#0f3d24] disabled:cursor-not-allowed disabled:opacity-50"
            >
              Continue →
            </button>
          ) : null}
