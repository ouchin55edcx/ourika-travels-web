    ...
    <aside className="w-full text-gray-700 lg:sticky lg:top-6 lg:w-[380px] lg:self-start">
      <div className="rounded-2xl border border-[#d9d9d9] bg-white p-4 shadow-[0_1px_0_rgba(0,0,0,0.03)] sm:p-5">
        <div className="mb-4 flex gap-4">
          ...
          <div>
            <h3 className="text-lg leading-tight font-bold text-[#1a1a1a]">
            ...
            <div className="mt-1 flex items-center gap-1 text-gray-700">
              <div className="flex items-center gap-0.5">
                {[...Array(5)].map((_, i) => (
                  <svg
                    key={i}
                    className={`h-3 w-3 ${i < 4 ? "text-green-500" : "text-gray-300"}`}
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
            ...
            <p className="mt-1 text-sm text-gray-700">By Mohamed</p>
          </div>
        </div>
        ...
        <div className="space-y-3 border-t border-gray-200 pt-4 text-gray-700">
          ...
          <button className="text-sm font-semibold text-gray-700 underline">Change</button>
        </div>
