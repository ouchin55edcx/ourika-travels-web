...
export default function GuideVerifyPage() {
  ...
  function handleSubmit() {
    ...
    startTransition(async () => {
      ...
      router.push("/register/guide/welcome");
    });
  }
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#f8faf8] px-4">
      ...
      <div className="w-full max-w-md rounded-3xl border border-gray-100 bg-white px-8 py-10 shadow-[0_30px_60px_rgba(0,0,0,0.06)]">
        ...
        <p className="mt-2 text-center text-sm font-medium text-gray-500">
          ...
          <span className="font-bold text-[#0a2e1a]">{email || "your email"}</span>
        </p>
        ...
        <div className="mt-6 text-center">
          <Link
            href="/register/guide"
            className="text-xs font-bold text-gray-400 transition-colors hover:text-[#0a2e1a]"
          >
            Wrong email? Go back
          </Link>
        </div>
