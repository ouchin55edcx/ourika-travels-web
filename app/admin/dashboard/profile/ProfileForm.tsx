    ...
    <form action={handleSubmit} className="space-y-8">
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            required
            className="w-full rounded-2xl border border-gray-200 bg-white px-4 py-3 text-gray-900 transition-all placeholder:text-gray-700 focus:border-[#0b3a2c] focus:ring-4 focus:ring-[#0b3a2c]/5 focus:outline-none"
        ...
        <div className="space-y-2 opacity-70">
          ...
          <p className="ml-1 text-[10px] text-gray-400">
            Email cannot be changed from the profile settings.
          </p>
        </div>
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          className="w-full resize-none rounded-2xl border border-gray-200 bg-white px-4 py-3 text-gray-900 transition-all placeholder:text-gray-700 focus:border-[#0b3a2c] focus:ring-4 focus:ring-[#0b3a2c]/5 focus:outline-none"
