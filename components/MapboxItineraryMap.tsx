  ...
  useEffect(() => {
    ...
    const updateMarkers = () => {
      ...
      pinned.forEach((s) => {
        ...
        el.className =
          "flex h-8 w-8 items-center justify-center rounded-full bg-[#0b3a2c] text-white font-black text-xs border-2 border-white shadow-xl cursor-default";
    ...
    <div className="relative h-full w-full overflow-hidden rounded-[2.5rem] bg-gray-100 shadow-inner">
      ...
      {pickingStepId !== null && (
        <div className="absolute top-6 left-1/2 z-10 -translate-x-1/2">
          <div className="flex animate-bounce items-center gap-2 rounded-full bg-[#0b3a2c] px-6 py-2.5 text-sm font-bold text-white shadow-2xl">
